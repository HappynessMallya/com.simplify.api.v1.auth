...
/**
 * Class ChangeUserStatusByIdControllerTest
 * @package App\Tests\Integration\Controller
 */
class ChangeUserStatusByIdControllerTest extends WebTestCase
{
    public function testChangeUserStatusByIdShouldBeSuccess()
    {
        // Given
        ...
        $parameters = [
            'operatorId' => '7ebe33c9-6f98-4131-b627-0a6d9730e7c8',
        ];

        // When
        $client->request(
            'PUT',
            '/api/v2/user/operator/' . $parameters['operatorId'] . '?newStatus=CHANGE_PASSWORD',
            [],
            [],
            [
    ...
    public function testChangeUserStatusByIdWithWrongOperatorIdShouldBeError()
    {
        // Given
        $client = self::createClient();
        ...
        $this->assertEquals(
            ...
            'Operator not found by id: ' . $parameters['operatorId'],
            $response['error']
        );
    }

    public function testChangeUserStatusByIdWithWrongUuidShouldBeError()
    {
        // Given
        $client = self::createClient();
    ...
    public function testChangeUserStatusByIdWithWrongUserTypeShouldBeError()
    {
        // Given
        $client = self::createClient();
