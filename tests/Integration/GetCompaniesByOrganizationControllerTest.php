...
/**
 * Class GetCompaniesByOrganizationControllerTest
 * @package App\Tests\Integration\Controller
 */
class GetCompaniesByOrganizationControllerTest extends WebTestCase
{
    public function testGetCompaniesByOrganizationShouldBeSuccess()
    {
        // Given
        ...
        $this->assertNotNull($response['companies']);
    }

    public function testGetCompaniesByOrganizationWithWrongUserTypeShouldBeError()
    {
        // Given
        $client = self::createClient();
